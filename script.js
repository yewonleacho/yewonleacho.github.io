...
function gameScreen(){
 ...
 //  	for (let slice of pizzas) {
 //    	slice.update(); // update snowflake position
 //    	slice.display(); // draw snowflake
 //  }
}
...
// 		if (this.posY > height){
// 			let index = pizzas.indexOf(this);
// 			pizzas.splice(index, 1);
// 		}
// 	}

// 	this.display = function() {
// 		image(pizza, this.posX, this.posY);
// 	}
// }
